...
// PURPOSE: Display mobile patrol reports
// =====================================================
...
$query = "
    ...
    WHERE p.patrol_type = 'Mobile Patrol'
";
...
$result = $conn->query("SELECT SUM(personnel_count) as total FROM patrol_activities WHERE patrol_type = 'Mobile Patrol'");
$stats['personnel'] = $result->fetch_assoc()['total'] ?? 0;

$result = $conn->query("SELECT COUNT(DISTINCT vehicle_number) as total FROM patrol_activities WHERE patrol_type = 'Mobile Patrol' AND vehicle_number IS NOT NULL");
        ...
        <div class="bg-white p-5 rounded-lg shadow-md overflow-x-auto">
            <table class="w-full border-collapse">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="9" class="p-6 text-center text-gray-500">No mobile patrol reports found</td>
                    </tr>
                    <?php else: ?>
