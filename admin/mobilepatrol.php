            ...
            <table class="w-full border-collapse">
                ...
                <tbody>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><a href="view_report.php?id=1&type=mobilepatrol" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><a href="view_report.php?id=2&type=mobilepatrol" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><span class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-xs">Pending</span></td>
                        <td class="p-3"><a href="view_report.php?id=3&type=mobilepatrol" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs">Approved</span></td>
                        <td class="p-3"><a href="view_report.php?id=4&type=mobilepatrol" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
