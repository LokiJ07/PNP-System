    ...
    <div class="flex-1 p-8 bg-[#eef2f6] overflow-y-auto h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-2xl font-bold text-[#08324f]">28</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-sm">
                <p class="text-gray-600 text-sm">Contraband Seized</p>
                <p class="text-2xl font-bold text-[#08324f]">15 kg</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-sm">
                <p class="text-gray-600 text-sm">Arrests Made</p>
                <p class="text-2xl font-bold text-[#08324f]">23</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-sm">
            ...
            <table class="w-full border-collapse">
                ...
                <tbody>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><a href="view_report.php?id=1&type=oplansita" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><a href="view_report.php?id=2&type=oplansita" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><span class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-xs">Pending</span></td>
                        <td class="p-3"><a href="view_report.php?id=3&type=oplansita" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs">Approved</span></td>
                        <td class="p-3"><a href="view_report.php?id=4&type=oplansita" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
