...
// PURPOSE: Display Oplan Bakal reports
// =====================================================
...
$query = "
    SELECT o.oplan_id, o.specific_location, o.oplan_date, o.oplan_time, 
           o.personnel_count, o.operations_count, o.arrests_made, o.firearms_seized,
    ...
    WHERE o.oplan_type = 'Oplan Bakal'
";
...
$result = $conn->query("SELECT SUM(personnel_count) as total FROM oplan_activities WHERE oplan_type = 'Oplan Bakal'");
...
$result = $conn->query("SELECT SUM(arrests_made) as total FROM oplan_activities WHERE oplan_type = 'Oplan Bakal'");
    ...
    <div class="flex-1 p-8 bg-[#eef2f6] overflow-y-auto h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-2xl font-bold text-[#08324f]"><?php echo $stats['firearms']; ?></p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-sm">
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-[#08324f] text-white">
                        ...
                        <th class="p-3 text-center">Firearms</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="10" class="p-6 text-center text-gray-500">No Oplan Bakal reports found</td>
                    </tr>
                    <?php else: ?>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3 text-center"><?php echo $row['firearms_seized']; ?></td>
