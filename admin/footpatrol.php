...
<body class="flex bg-[#0a3d62]">
        ...
        <ul class="space-y-1">
            ...
            <li class="dropdown active">
                ...
                <ul class="pl-8 mt-1 space-y-1 dropdown-content" style="display: block;">
                    <li class="py-2 px-3 text-sm bg-[#0a3d62] rounded"><a href="footpatrol.php" class="text-white no-underline block">Foot Patrol</a></li>
    ...
    <div class="flex-1 p-8 bg-[#eef2f6] overflow-y-auto h-screen">
        <h2 class="text-2xl font-bold text-[#08324f] mb-6">Foot Patrol Reports</h2>

        <!-- Summary Cards -->
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white p-4 rounded-lg shadow-sm">
                <p class="text-gray-600 text-sm">Total Foot Patrols</p>
                <p class="text-2xl font-bold text-[#08324f]">24</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-sm">
                <p class="text-gray-600 text-sm">Active Personnel</p>
                <p class="text-2xl font-bold text-[#08324f]">12</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-sm">
                <p class="text-gray-600 text-sm">Accomplishments</p>
                <p class="text-2xl font-bold text-[#08324f]">48</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-sm">
                <p class="text-gray-600 text-sm">Photos Uploaded</p>
                <p class="text-2xl font-bold text-[#08324f]">36</p>
            </div>
        </div>
            ...
            <table class="w-full border-collapse">
                ...
                <tbody>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><a href="view_report.php?id=1&type=footpatrol" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><a href="view_report.php?id=2&type=footpatrol" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><span class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-xs">Pending</span></td>
                        <td class="p-3"><a href="view_report.php?id=3&type=footpatrol" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-3"><span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs">Approved</span></td>
                        <td class="p-3"><a href="view_report.php?id=4&type=footpatrol" class="bg-[#0a3d62] text-white px-4 py-1.5 rounded text-sm hover:bg-[#08324f] inline-block">View</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
