...
// PURPOSE: Display foot patrol reports
// =====================================================
...
$query = "
    ...
    WHERE p.patrol_type = 'Foot Patrol'
";
...
$result = $conn->query("SELECT SUM(personnel_count) as total FROM patrol_activities WHERE patrol_type = 'Foot Patrol'");
        ...
        <div class="bg-white p-5 rounded-lg shadow-md overflow-x-auto">
            <table class="w-full border-collapse">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="8" class="p-6 text-center text-gray-500">No foot patrol reports found</td>
                    </tr>
                    <?php else: ?>
